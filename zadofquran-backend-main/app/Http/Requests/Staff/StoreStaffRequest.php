...
class StoreStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone' => ['nullable', 'string', 'max:255', 'phone_number', 'unique:staff,phone,NULL,id,deleted_at,NULL'],
            'email' => ['nullable', 'email', 'max:255', 'unique:staff,email,NULL,id,deleted_at,NULL'],
